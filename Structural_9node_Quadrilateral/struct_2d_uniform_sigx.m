...
% Imposition of B.C.
Kreduce = K([3,5,9:12,15:18,21:24,27,29],[3,5,9:12,15:18,21:24,27,29]);
Freduce = F([3,5,9:12,15:18,21:24,27,29]);

% Finding Solution
ureduce = inv(Kreduce)*Freduce;
un = [0;0;ureduce(1);0;ureduce(2);0;0;0;ureduce(3:6);0;0;ureduce(7:10);0;0;ureduce(11:14);0;0;ureduce(15);0;ureduce(16);0];
...
fprintf(fid,'--\n');
for i = 1:30
   fprintf(fid,'%10.3e  %10.3e  %10.3e  %10.3e  %10.3e  %10.3e\n\n',K(i,1:10));
end
fprintf(fid,'\n\n\n');
for i = 1:30
   fprintf(fid,'%10.3e  %10.3e  %10.3e  %10.3e  %10.3e  %10.3e\n\n',K(i,11:20));
